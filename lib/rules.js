...
function inTime(rulename, obj, feiertage, latitude, longitude) {
    ...
    if (obj) {
        ...
        if (obj.duration) {
            obj.duration = getTimeFromRange(name + "_duration", obj.duration, latitude, longitude);
        }

        if (obj.from) {
            obj.from = getTimeFromRange(name + "_from", obj.from, latitude, longitude);
        }

        if (obj.to) {
            obj.to = getTimeFromRange(name + "_to", obj.to, latitude, longitude);
        }
