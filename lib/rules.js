          ...
          if (!this.simulation) {
            ...
            if (ruleCopyRules.id && ruleCopyRules.value !== undefined && ruleCopyRules.value !== null) {
              ...
              if (typeof ruleCopyRules.oldRegel !== 'undefined') {
                this.adapter.log.info(ruleCopyRules.rulename + ', old rule ' + ruleCopyRules.oldRegel + ', new rule ' + ruleCopyRules.regel + ', from old value ' + ruleCopyRules.oldValue + ' to new value ' + ruleCopyRules.value + '.');
              } else {
                this.adapter.log.info(ruleCopyRules.rulename + ', rule ' + ruleCopyRules.regel + ' to value ' + ruleCopyRules.value + '.');
              }
